...
SCRIPTS_FOLDER = os.path.join(ROOT_DIR, "")
	...
	with open(os.path.join(TEXT_FOLDER,"images.txt"), "r") as f:
		...
		for line in f:
			...
			if  i % 2 == 1:
				...
				image_rel_custom = "images"  # 修改为相对路径
    
				name_custom = str(f"./{image_rel_custom}/{'_'.join(elems[9:])}")
				...
				frame = {"file_path":name_custom,"sharpness":b,"transform_matrix": c2w}  # 修改为相对路径
				if len(cameras) != 1:
